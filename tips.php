...
<<<<<<< HEAD
          <div class="body">
			...
			<ul>
				<li>
					<?php
						$a = new Area('Gardening_Image1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<?php
						$a = new Area('Gardening_Content1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<?php
						$a = new Area('Gardening_Description1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
				</li>
				<li>
					<?php
						$a = new Area('Gardening_Image2');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<?php
						$a = new Area('Gardening_Content2');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<ul>
						<?php
							$a = new Area('Gardening_Description2');
							$a->setAreaGridMaximumColumns(12);
							$a->display($c);
						?>
					</ul>
