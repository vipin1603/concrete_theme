...
<div id="page">
        ...
        <div class="body">
			<div id="blog">
				<div class="article">
					<?php
						$a = new Area('Blog_Heading1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<?php
						$a = new Area('Blog_Content1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
					<?php
						$a = new Area('Blog_Description1');
						$a->setAreaGridMaximumColumns(12);
						$a->display($c);
					?>
				</div>
				<div class="sidebar">
					<?php
							$a = new Area('Blog_List_Heading1');
							$a->setAreaGridMaximumColumns(12);
							$a->display($c);
						?>
					<ul>
						<?php
							$a = new Area('Blog_List1');
							$a->setAreaGridMaximumColumns(12);
							$a->display($c);
						?>
					</ul>
					<?php
							$a = new Area('Blog_List_Heading2');
							$a->setAreaGridMaximumColumns(12);
							$a->display($c);
						?>
					<ul>
						<?php
							$a = new Area('Blog_List2');
							$a->setAreaGridMaximumColumns(12);
							$a->display($c);
						?>
					</ul>
